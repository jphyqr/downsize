...
export function ContactFreelancerForm({name, email, phone, onSuccess} : {name: string, email: string, phone: string, onSuccess: ()=>void}) {
  // 1. Define your form.
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    const res = await fetch('/api/email', {
      ...
      console.log({err
        ...
        toast({
            title: "E-mail sent ",
            description: "Email sent to the freelancer. They will get back to you soon.",
            action: (
